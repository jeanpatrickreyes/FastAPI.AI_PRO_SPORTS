"""
AI PRO SPORTS - Main FastAPI Application
...
async def lifespan(app: FastAPI):
    ...
    """
    logger.info("=" * 60)
    logger.info("AI PRO SPORTS - Phase 4 Enterprise Platform")
    logger.info("=" * 60)
    ...
    try:
        ...
        await alerting_service.info(
            "System Startup",
            f"AI PRO SPORTS Phase 4 started successfully in {settings.environment} mode"
        )
    ...
    try:
        ...
        await alerting_service.info(
            "System Shutdown",
            "AI PRO SPORTS Phase 4 shutting down gracefully"
        )
