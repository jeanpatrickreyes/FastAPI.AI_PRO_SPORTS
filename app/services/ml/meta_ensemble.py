"""
Meta-Ensemble Module for AI PRO SPORTS

Combines predictions from H2O AutoML, AutoGluon, and Sklearn ensemble
using optimized weights based on validation performance.
"""
...
class FrameworkPrediction:
    ...
    framework: str  # 'h2o', 'autogluon', 'sklearn'
    probability: float
    confidence: float
    model_id: str
    features_used: int
