"""
AI PRO SPORTS - Phase 4 Enterprise Configuration
...
class Settings(BaseSettings):
    ...
    TOTP_ISSUER: str = "AI PRO SPORTS"
    TOTP_TIME_STEP: int = 30
    
    # Database Settings
    DATABASE_URL: str = "postgresql+asyncpg://postgres:postgres@localhost:5432/ai_pro_sports"
